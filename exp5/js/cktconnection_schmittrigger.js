jsPlumb.ready(function () {
	...
	var correct_connections_6_11 = [
		...
		var is_connected_12_16 = false;
        var is_connected_4_5 = false;
		var is_connected_13_16 = false;
		var is_connected_14_11 = false;
	...
	actual_connections.forEach(function (connection) {
            ...
            if(!is_connected_12_16){
                is_connected_12_16 = correct_connections_12_16.find(function (conn) {
                    return conn.source === this_connection.source && conn.target === this_connection.target;
                });
            }
              // if this_connection exists in correct_connections
		...
		actual_connections.forEach(function (connection) {
            ...
            if(!is_connected_14_11){
                is_connected_14_11 = correct_connections_14_11.find(function (conn) {
                    return conn.source === this_connection.source && conn.target === this_connection.target;
                });
            }
              // if this_connection exists in correct_connections
        ...
        if ((is_connected_1_7 || is_connected_1_3) && is_connected_3_7 && is_connected_8_9 &&  (is_connected_6_11 || is_connected_6_14) && is_connected_12_16 &&  is_connected_4_5  && is_connected_8_15 && is_connected_13_16 && is_connected_14_11 &&  !unallowed_connection_present) {

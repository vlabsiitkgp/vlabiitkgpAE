...
function tabled(){
   ...
   //-----------------------------------------------------------phase calculation----------------------------------------------------//        
        ...
        var phi = -Math.atan( parseFloat(f) / parseFloat(fl))-Math.atan(parseFloat(f) /parseFloat(fh));//phase shift
...
//var c=0.01e-9; 	
	var passbandgain=(1+rf/r); 
	var fl= Math.sqrt(1 / (2 * 3.14 *r * parseFloat(cld)));
	var fh= Math.sqrt(1 / (2 * 3.14 *r * parseFloat(cld)));
  	var absolutehigh = (passbandgain*(f/fl))/(Math.sqrt(1+Math.pow((f/fl),2)));
	var absolutelow = (passbandgain)/(Math.sqrt(1+Math.pow((f/fh),2)));
       // h += absolute + "<br>";

jsPlumb.ready(function () {
    ...
    instance.batch(function () {
        ...
        instance.connect({ source: e1, target: e6 });
        instance.connect({ source: e1, target: e3 });
        instance.connect({ source: e1, target: e4 });
instance.connect({ source: e1, target: e5 });
instance.connect({ source: e1, target: e7 });
        instance.connect({ source: e1, target: e8 });
        instance.connect({ source: e1, target: e9 });
instance.connect({ source: e1, target: e12 });

jsPlumb.ready(function () {
    ...
    document.getElementById("check-button").addEventListener("click", function () {
		...
		var is_connected_10_19 = false;
       var is_connected_18_9 = false;
		...
		actual_connections.forEach(function (connection) {
            ...
            if(!is_connected_10_19){
                is_connected_10_19 = correct_connections_10_19.find(function (conn) {
                    return conn.source === this_connection.source && conn.target === this_connection.target;
                  });
            }
       ...
       actual_connections.forEach(function (connection) {
            ...
            if(!is_connected_18_9){
                is_connected_18_9 = correct_connections_18_9.find(function (conn) {
                    return conn.source === this_connection.source && conn.target === this_connection.target;
                  });
            }
       ...
       // if (is_connected_1_12 && is_connected_14_12 ) {
		if (is_connected_1_12 && is_connected_14_12 && is_connected_16_12 && is_connected_3_17 && is_connected_8_9 && is_connected_5_15 && is_connected_6_13 && is_connected_2_13 &&  is_connected_4_9 && is_connected_7_19 && is_connected_11_13 && is_connected_10_19 && is_connected_18_9 && !unallowed_connection_present) {
